            ...
            <div class="song-card" data-song-id="${song.id}">
                <div class="song-card-inner">
                    ...
                    <div class="song-cover">
                        <img src="${cardInfo.coverImage}" alt="${cardInfo.name} cover" onerror="this.src='assets/covers/default.jpg'">
                    </div>
...
function updateDetailsPanel(songId) {
    ...
    const bestScoreHtml = generateStarsHTML(starDisplay.filledStars, starDisplay.emptyStars);
